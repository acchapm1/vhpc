# Rocky Linux 9.7 HPC Cluster - Quick Start Guide

Virtual HPC cluster using Rocky Linux 9.7 with Docker.
...
For hpc-rocky9/docker/cluster-config.yml:
...
- hpc-rocky9: 172.29.10.2-172.29.10.254
