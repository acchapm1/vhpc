# HPC Cluster with KubeVirt on minikube (Rocky Linux 9)

Deploy a virtual HPC cluster using KubeVirt on minikube. VM rootdisks are imported from the Rocky 9 GenericCloud qcow2 by CDI on first deploy.
